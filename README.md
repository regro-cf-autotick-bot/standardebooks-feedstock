...
pixi add standardebooks
# for installing globally
pixi global install standardebooks
```
...
It is possible to list all of the versions of `standardebooks` available on your platform:
...
```
pixi search standardebooks --channel conda-forge
```
